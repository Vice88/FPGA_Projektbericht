...
\begin{itemize}
	...
	\item portable os for the dev kit (partial reconfiguration) LINUX KERNEL
...
\subsection{Prerequisites}
The hardware used in this part of the project was a former development kit from Altera with an FPGA Cyclone IV.\\
